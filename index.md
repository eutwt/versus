...
Use [`compare()`](https://eutwt.github.io/versus/reference/compare.md)
...
Use
[`value_diffs()`](https://eutwt.github.io/versus/reference/value-diffs.md)
...
Use
[`slice_diffs()`](https://eutwt.github.io/versus/reference/slice_diffs.md)
...
to get the unmatched rows from one or both tables.
...
Use [`summary()`](https://rdrr.io/r/base/summary.html) to see what kind
of differences were found
